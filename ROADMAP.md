...
- [ ] Menu hambúrguer (Header mobile)
- [ ] Botão WhatsApp flutuante
- [ ] Validar scroll suave entre âncoras em todos os breakpoints
...
## 🔲 Fase 4 — Responsividade e polish

- [ ] Auditoria visual mobile (375px, 390px, 430px)
- [ ] Auditoria visual tablet (768px)
- [ ] Validar hover states e micro-animações
- [ ] Acessibilidade básica (contraste, headings, áreas de toque, alt)
...
- [ ] Configurar domínio no Resend e atualizar from/to no route.ts
